...
def generate_launch_description():
    ...
    # ur_robot_driver requires robot_ip even in fake hardware mode
    ur_driver = IncludeLaunchDescription(
        ...
        launch_arguments={
            "ur_type": ur_type,
            "robot_ip": robot_ip,  # IMPORTANT: required
    ...
    auto_spawn_gripper = TimerAction(
        period=3.5,
        actions=[gripper_spawner]from launch import LaunchDescription
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, TimerAction
from launch.conditions import IfCondition
from launch.launch_description_sources import PythonLaunchDescriptionSource
from launch.substitutions import LaunchConfiguration, PathJoinSubstitution
...
def generate_launch_description():
    ...
    ur5e_cfg_dir = PathJoinSubstitution([
        FindPackageShare("ur5_custom_description"),
        "config",from launch import LaunchDescription
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, TimerAction
from launch.conditions import IfCondition
from launch.launch_description_sources import PythonLaunchDescriptionSource
from launch.substitutions import LaunchConfiguration, PathJoinSubstitution
